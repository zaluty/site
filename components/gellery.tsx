...
import { InView } from "./c/gallery";
import Image from "next/image";

export function InViewImagesGrid() {
  return (
    <div className="h-full w-full overflow-auto">
      <div className="mb-20 py-12 text-center text-primary text-sm">
        A gallery you might like
      </div>
      <div className="flex  mt-12 items-end justify-center pb-12">
        <InView
