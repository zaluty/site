...
export const metadata = {
  title: "Projects",
  image: "https://github.com/zaluty.png",
};
...
Picture this: You're coding late at night, fueled by caffeine and inspiration. You push your latest masterpiece to GitHub, only to realize – horror of horrors – you've just exposed your precious API keys to the world. Again.
